  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-[800px] pb-3'
      >
      ...
      >
        ...
        <img
          src={assets.bgImage1}
          alt=""
          className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-10 hidden dark:block'
        />
